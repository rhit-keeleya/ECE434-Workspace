...
static unsigned int gpioLED2 = 115;           ///< Default GPIO for the LED is 115
module_param(gpioLED2, uint, S_IRUGO);       ///< Param desc. S_IRUGO can be read/not changed
MODULE_PARM_DESC(gpioLED2, " GPIO LED number (default=115)");     ///< parameter description
...
static bool led2On = 0;                      ///< Is the LED2 on or off? Used for flashing
static bool cycle = 0;                       ///< Used for varying period...
